export default function TermsAndConditions(name = 'Aries Living', email = 'info') {
  return [
    `Reservations require a valid credit card at the time of booking (Visa, American Express, MasterCard, Discover), email and mobile phone number. ${name} does not accept cash or check payments.`,
    ...
    `${name} does not share customer information and credit card transactions to comply with Payment Card Industry (PCI) Data Security Standards. If you would like to review, correct, update, or delete Personal Information that you have previously provided to us, you may contact us by calling or texting us at 1.813.575.4532 or via email at: ${email}@ariesliving.com.`
  ]
}
