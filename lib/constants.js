...
export const CONTENT = [
...

  {
    ...
    id: 'portfolio',
    description:
      'The Aries Living Portfolio consists of select service hotels in Eastern United States concentrated in the Miami Area. Our growth strategy is to increase our footprint with similar style accommodations properties on the East Coast both North and South.',
    src: '/showcase/villa-paradiso/exterior/1.jpg',
    alt: 'vp'
  },
  {
    title: 'Investors',
...
export const TEAM = {
  ...
  id: 'team',
  description:
    'The Aires Living Team has decades of experience in all facets of hospitality, technology, and real estate. This experience is applied with youthful energy, drawing up creative solutions to move the accommodations industry forward and to create more value for our assets.'
}

export const HOTELS = [
  { name: 'Villa Paradiso Hotel', url: 'https://villaparadisohotels.com' },
  { name: 'Treehouse Studio Hotel', url: 'https://treehousebyaries.com' },
  { name: 'Ithaca of South Beach Hotel', url: 'https://ithacasouthbeach.com' }
]
