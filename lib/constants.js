...
export const TEAM = [
  { name: 'Max Khaghan', position: 'CEO', description: '', img: '' },
  { name: 'James Khaghan', position: 'CFO', description: '', img: '' },
  { name: 'Dan Martin', position: 'C__', description: '', img: '' },
  { name: 'Daniel Tennant', position: 'C__', description: '', img: '' },
  { name: 'Jordan Goldman', position: 'C__', description: '', img: '' }
]
